...
ActiveRecord::Schema.define(version: 20140921015437) do
  ...
  add_index "attends", ["user_id", "event_id"], name: "index_attends_on_user_id_and_event_id", unique: true, using: :btree
